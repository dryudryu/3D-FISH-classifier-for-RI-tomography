...
__all__ = [
    'DenseNet', 'densenet121', 'densenet169', 'densenet201', 'densenet264', 'hydensenet'
]
...
if __name__ == "__main__":
    net = d169_3d(num_classes=18, sample_size=64, sample_duration=96, norm="bn", act="lrelu")
    from torchsummary import summary

    summary(net.cuda(), (1, 96, 96, 42))
